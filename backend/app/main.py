...
from .workers.processor import LocalPlaceholderProcessor, Processor
...
def create_app(
    *,
    ...
    app = FastAPI(title="AI Photo Restorer", version=settings.api_version)
...
# Default app for `uvicorn backend.app.main:app` and Modal ASGI mounting.
app = create_app()
