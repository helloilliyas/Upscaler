...
codes. The HTTP status is derived from the code so handlers stay consistent.
"""
...
class ErrorCode(str, Enum):
    ...
    FRAME_RATE_TOO_HIGH = "FRAME_RATE_TOO_HIGH"
...
_HTTP_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.FRAME_RATE_TOO_HIGH: 422,
...
class ApiError(Exception):
    ...
    private video bytes, raw tokens, or full emails.
    """
